import { Box, Button, Flex, Heading, HStack, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverHeader, PopoverTrigger, Skeleton, Text } from "@chakra-ui/react";
...
export default function BookDetails({ book }) {
  ...
  return (
    <Wrapper>
      <Flex my="6">
        <Box w="300px">
          <Image alt="123" loading="lazy" width="300" height="300" decoding="async" src={`/${book.image}`} />
        </Box>
        <Box ml="8">
